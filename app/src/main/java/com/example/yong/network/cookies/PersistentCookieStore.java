    ...
    public String toString() {
        ...
        if(cookies != null){
            ...
            for(String key : keys){
                sb.append(" key == " + key);
                sb.append("/n");
                ConcurrentHashMap<String, HttpCookie> values = cookies.get(key);
                Set<String> keys2 = values.keySet();
                for(String sss : keys2){
                    sb.append( " key2 == " + sss);
                    HttpCookie httpCookie = values.get(sss);
                    sb.append( " httpCookie.toString() == " + httpCookie.toString());
                }
            }
        }
